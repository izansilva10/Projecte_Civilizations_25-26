...
public class ArmyPanel {
    ...
    public VBox getPanel() {
        ...
        Button swordsmanBtn = createUnitButton("Espadachín", "Comida: 8,000\nMadera: 3,000\nHierro: 50", "button-attack", "/img/units/swordsman.png", 0);
        Button spearmanBtn = createUnitButton("Lancero", "Comida: 5,000\nMadera: 6,500\nHierro: 50", "button-attack", "/img/units/spearman.png", 1);
        Button crossbowBtn = createUnitButton("Ballesta", "Madera: 45,000\nHierro: 7,000", "button-attack", "/img/units/crossbow.png", 2);
        Button cannonBtn = createUnitButton("Cañón", "Madera: 30,000\nHierro: 15,000", "button-attack", "/img/units/cannon.png", 3);
        ...
        Button arrowTowerBtn = createUnitButton("Torre Flechas", "Madera: 2,000", "button-defense", "/img/units/arrow_tower.png", 4);
        Button catapultBtn = createUnitButton("Catapulta", "Madera: 4,000\nHierro: 500", "button-defense", "/img/units/catapult.png", 5);
        Button rocketBtn = createUnitButton("Torre Cohete", "Madera: 50,000\nHierro: 5,000", "button-defense", "/img/units/rocket_launcher.png", 6);
        ...
        Button magicianBtn = createUnitButton("Mago", "Comida: 12,000\nMadera: 2,000\nManá: 5,000", "button-special", "/img/units/magician.png", 7);
        Button priestBtn = createUnitButton("Sacerdote", "Comida: 15,000\nManá: 15,000", "button-special", "/img/units/priest.png", 8);

        specialGrid.add(magicianBtn, 0, 0);
        specialGrid.add(priestBtn, 1, 0);

        contentContainer.getChildren().addAll(
            attackTitle, attackGrid, new Separator(),
            defenseTitle, defenseGrid, new Separator(),
    ...
    private void createUnit(Civilization civ, int unitType, String unitName, String costStr) {
        ...
        // Formatear el coste para que se vea bonito en el diálogo
        String headerText = "Coste por unidad:\n" + costStr;
