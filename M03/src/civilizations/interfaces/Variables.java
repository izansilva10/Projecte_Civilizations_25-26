...
public interface Variables 
{
    ...
    // TECHNOLOGY COST (Sincronizado con Civilization.java)
    ...
    public final int UPGRADE_BASE_DEFENSE_TECHNOLOGY_WOOD_COST = 200; // Añadido (según tu constructor)
    public final int UPGRADE_BASE_ATTACK_TECHNOLOGY_WOOD_COST = 200;  // Añadido (según tu constructor)
    public final int UPGRADE_BASE_DEFENSE_TECHNOLOGY_FOOD_COST = 100; // Añadido (según tu constructor)
    public final int UPGRADE_BASE_ATTACK_TECHNOLOGY_FOOD_COST = 100;  // Añadido (según tu constructor)
    ...
    //Cost Buildings (Añadido lo que faltaba para compilar)
    ...
    public final int MANA_COST_CHURCH = 2000;     // Añadido para newChurch()
    ...
    public final int MANA_COST_MAGICTOWER = 5000;  // Añadido para newMagicTower()
